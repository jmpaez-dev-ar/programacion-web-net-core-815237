...
namespace GestionComercial.Data.Repositorios
{
    public class RepositorioGenerico<T> : IRepositorioGenerico<T> where T : class
    {
        ...
        public RepositorioGenerico(
            ...
            ILogger<RepositorioGenerico<T>> logger)
        {
        ...
        public async Task<List<T>> ObtenerTodosAsync(bool sinSeguimiento = true)
        {
            ...
            {
                _logger.LogError($"Error al obtener todos los registros: {ex.Message}", ex);
                throw;
            }
        }
        ...
        public async Task<T?> ObtenerPorIdAsync(int id, bool sinSeguimiento = true)
        {
            ...
            {
                _logger.LogError($"Error al obtener el registro por ID: {ex.Message}", ex);
                throw;
            }
        }
        ...
        public async Task<List<T>> ObtenerPorCondicionAsync(Expression<Func<T, bool>> expresion, bool sinSeguimiento = true)
        {
            ...
            {
                _logger.LogError($"Error al obtener registros por condición: {ex.Message}", ex);
                throw;
            }
        }
        ...
        public async Task CrearAsync(T entidad)
        {
            ...
            {
                _logger.LogError($"Error al crear un nuevo registro: {ex.Message}", ex);
                throw;
            }
        }
        ...
        public async Task ActualizarAsync(T entidad)
        {
            ...
            {
                _logger.LogError($"Error al actualizar el registro: {ex.Message}", ex);
                throw;
            }
        }
        ...
        public async Task EliminarAsync(T entidad)
        {
            ...
            {
                _logger.LogError($"Error al eliminar el registro: {ex.Message}", ex);
                throw;
            }
        }
        ...
        public async Task<List<T>> ObtenerPaginadoAsync(int numeroPagina, int tamañoPagina, bool sinSeguimiento = true)
        {
            ...
            {
                _logger.LogError($"Error al obtener registros paginados: {ex.Message}", ex);
                throw;
            }
        }
    }
